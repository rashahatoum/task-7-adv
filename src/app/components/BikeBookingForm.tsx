...
export default function BikeBookingForm() {
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full max-w-734 bg-[#FFFFFF4D] rounded-3xl py-30 px-34 shrink-0 flex-1">
                ...
                <div className="flex flex-col justify-center gap-2 text-left">
                    ...
                    <div className="relative">
                        <select
                            ...
                            onChange={handleChange}
                            className="w-full px-16 py-14 text-gray-500 text-base rounded-lg border border-[#33333333] focus:border-main-orange focus:outline-none shadow-sm appearance-none cursor-pointer pr-10"
                            required
                        >
                            <option value="" disabled hidden >Select the service types</option>
